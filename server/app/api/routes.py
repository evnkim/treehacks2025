...
from app.api.ai_insights import analyze_code_quality, explain_code, summarize_pr, analyze_file
...
@api_bp.route("/analyze/folder", methods=["POST"])
def analyze_folder():
    """
    Expects JSON with:
...
@api_bp.route("/github/list-files/<repo_owner>/<repo_name>", methods=["GET"])
...
@api_bp.route("/github/get-file/<repo_owner>/<repo_name>", methods=["GET"])
